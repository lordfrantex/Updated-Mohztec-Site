...
const Page = ({ params }) => {
    ...
    const fetchBlog = async (slug) => {
        try {
            ...
            const res = await fetch(`${process.env.https://mohztec-technologies.onrender.com}/api/blog/${slug}`, { cache: "no-cache" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.https://mohztec-technologies.onrender.com}/api/blog/${slug}`, {
                method: 'PATCH',
                headers: {
