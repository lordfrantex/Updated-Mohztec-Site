...
const Page = ({ params }) => {
    ...
    const fetchProject = async (slug) => {
        try {
            ...
            const res = await fetch(`${process.env.https://mohztec-technologies.onrender.com}/api/project/${slug}`, { cache: "no-cache" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.https://mohztec-technologies.onrender.com}/api/project/${slug}`, {
                method: 'PATCH',
                headers: {
